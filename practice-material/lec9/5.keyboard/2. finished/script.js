...
function onSearchBarInput(event) {
  ...
  if (event.target.value.length > 0) {
    jumbotronSubtitle.innerHTML = "SEARCH FOR";
    jumbotronTitle.innerHTML = event.target.value;
  } else {
    jumbotronSubtitle.innerHTML = "APPLICATION EXCLUSIVE";
    jumbotronTitle.innerHTML = "Today’s Photo";
  }
}

...
var jumbotronStat = document.querySelector('.jumbotron__stat');
var viewsCount = jumbotronStat.querySelector('.views-count');
var likesCount = jumbotronStat.querySelector('.likes-count');

function onMouseMove(event) {
  viewsCount.innerHTML = event.x;
  likesCount.innerHTML = event.y;
}
